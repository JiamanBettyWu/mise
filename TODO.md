...
1. **Keep clicking thumbs** — in the daily emails or the new web thumbs on Today's Outfit (#41); both write the same row. #42 is live, so every verdict now moves sampling weights (gently: one 👎 ≈ −5% per item). The loop only gets smart with volume; a couple weeks of verdicts makes the multipliers meaningful.
...
- [#59 Recent thumbed outfits into the outfit prompt](https://github.com/JiamanBettyWu/wardrobe-ai/issues/59)
- [#60 👎 attribution follow-up (web chips + email landing page) + weather/notes logging](https://github.com/JiamanBettyWu/wardrobe-ai/issues/60)
- [#61 Profile page: user-provided preferences](https://github.com/JiamanBettyWu/wardrobe-ai/issues/61)
- [#62 Weekly preference-inference job](https://github.com/JiamanBettyWu/wardrobe-ai/issues/62) (sequenced last — needs verdict volume; depends on #60 + #61)
- [#63 Candidates per mode + deterministic 👎-combo filter](https://github.com/JiamanBettyWu/wardrobe-ai/issues/63) (depends on #60; adjacent to #17)
- [#64 Calendar-driven mode selection (optional, ICS)](https://github.com/JiamanBettyWu/wardrobe-ai/issues/64)
