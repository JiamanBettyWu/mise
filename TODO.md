...
2. **[#18](https://github.com/JiamanBettyWu/wardrobe-ai/issues/18) warmth in prompt + extremes gate** — now unblocked (#40 shipped, all 64 items rated). Last structural piece of the feedback-loop plan; #42 waits on a couple weeks of verdicts. While in the catalog UI, spot-check a few inferred warmth values and correct any that look off (corrections stick).
...
- [#18 Weather fit: warmth in prompt + extremes gate](https://github.com/JiamanBettyWu/wardrobe-ai/issues/18) (rewritten 2026-06-09, replaces soft multiplier; **unblocked** — #40 shipped + backfilled 2026-06-10)
